    ...
    ERC20L2BridgeableUpgradeable
{
     ...
     */
    function initialize(address owner_, address _l2GatewayAddress, address _l1TokenAddress) external initializer {
        ...
        __ERC20Votes_init();
        __ERC20L2BridgeableUpgradeable_init(_l2GatewayAddress, _l1TokenAddress);
        __Ownable2Step_init();
